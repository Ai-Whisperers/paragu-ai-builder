...
- Name: commerce-storefront.test.ts >> Viajero Comercio - Storefront >> quick filters toggle
- Location: tests/e2e/commerce-storefront.test.ts:60:7
...
Expected pattern: /on_sale=1/
Received string:  "http://localhost:3000/s/es/viajero-comercio/tienda"

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    7 × unexpected value "http://localhost:3000/s/es/viajero-comercio/tienda"
  ...
  - generic [ref=e3]:
    ...
    - main [ref=e29]:
      ...
      - generic "Filtros rápidos" [ref=e155]:
        - button "🔥 En oferta" [disabled] [ref=e156]
        - button "💰 Hasta Gs 100.000" [disabled] [ref=e157]
        - button "💰 Gs 100.000 – 300.000" [disabled] [ref=e158]
        - button "💰 Gs 300.000+" [disabled] [ref=e159]
        - button "✅ Solo en stock" [disabled] [ref=e160]
      - generic [ref=e161]:
        - generic [ref=e162]:
          - search [ref=e163]:
            - generic [ref=e164]:
