...
- Name: commerce-storefront.test.ts >> Viajero Comercio - Storefront >> sort products by price
- Location: tests/e2e/commerce-storefront.test.ts:71:7
...
Expected pattern: /sort=price-asc/
Received string:  "http://localhost:3000/s/es/viajero-comercio/tienda"

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    8 × unexpected value "http://localhost:3000/s/es/viajero-comercio/tienda"
