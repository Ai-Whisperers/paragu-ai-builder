...
/**
 * Enhanced Footer section with improved aesthetics.
 * 
 * Improvements:
      ...
      <Container>
        <div className="font-heading grid gap-10 sm:gap-12 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
          ...
          <div className="font-heading sm:col-span-2 lg:col-span-1">
            ...
            <p className="font-heading text-sm leading-relaxed opacity-80">
              {address && <span className="font-heading block">{address}</span>}
              <span>{city}</span>
            </p>
          </div>
          ...
          {(instagram || facebook || waPhone) && (
            <div>
              ...
              <div className="font-heading flex flex-wrap gap-3">
                  ...
                  >
                    <svg className="font-heading w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {hasSiblings && (
          <div 
            className="font-heading mt-12 pt-8"
          ...
          >
            ...
            <ul className="font-heading flex flex-wrap gap-x-6 gap-y-3 text-sm">
