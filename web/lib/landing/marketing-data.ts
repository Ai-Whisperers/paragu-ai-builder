...
export const TEMPLATES: readonly Template[] = [
  ...
  { id: 'meal_prep', name: 'Meal Prep & Compras', icon: 'ShoppingCart', leads: 0, pct: 0, color: '#3a6b4a', demoSlug: null, seoHeadline: 'Sitio web para meal prep y entregas — menú semanal y pedidos por WhatsApp', seoLead: 'Menú semanal con precios en Gs, selección de platos y checkout directo por WhatsApp. Listo para escalar.' },
